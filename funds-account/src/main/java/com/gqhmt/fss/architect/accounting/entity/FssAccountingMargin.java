 ...
 */
@Entity
@Table(name = "t_gq_fss_accounting_margin")
public class FssAccountingMargin implements Serializable{
    ...
    @Column(name = "deduct_margin")
    private Long deductMargin; 
	...
	public Long getDeductMargin() {
		return deductMargin;
	}

	public void setDeductMargin(Long deductMargin) {
