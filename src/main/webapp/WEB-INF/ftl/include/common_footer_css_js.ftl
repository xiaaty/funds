<!-- jQuery文件。务必在bootstrap.min.js 之前引入 -->
        ...
        <script type="text/javascript" src="/js/plugin/bootstrap-datetimepicker/bootstrap-datetimepicker.js" charset="UTF-8"></script>
        <script type="text/javascript" src="/js/plugin/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>

        <link rel="stylesheet" type="text/css" media="screen" href="/css/bootstrap/bootstrap-datetimepicker.css">
