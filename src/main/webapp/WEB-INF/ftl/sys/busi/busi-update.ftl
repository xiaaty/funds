                                                ...
                                                <td>
                                                    <section style="width:250px">
                                                        <label class="text">
                                                            ...
                                                            <input type="radio" name="authIpType" value="1" <#if (busi.authIpType == '1')> checked </#if>/>IP全校验
                                                            <input type="radio" name="authIpType" value="2" <#if (busi.authIpType == '2')> checked </#if>/>IP段校验
                                                        </label>
                                                    </section>
                                                </td>
                                            </tr>
