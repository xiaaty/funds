...
<div class="jarviswidget" id="wid-id-410" data-widget-deletebutton="false" data-widget-editbutton="false">
    <header>
        <h2>快速搜索</h2>
    </header>
    <!-- widget div-->
    <div>
        <form class="smart-form" method="post" id="accountForm" action="${contextPath}/water/waterBank">
            <!-- widget edit box -->
                ...
                <div class="mt10 mb10">
                    <table class="table lh32">
                        ...
                        <tr >
                            ...
                            <td class="lh32 tr">交易账户：</td>
                            <td>
                                <label class="select" style="width:210px" >
                                    <select  name="map[orgID]" >
                                        <option value="0">全部</option>
                                        <c:forEach var="map" items="${bankAccountMap}">
...
<div class="alert alert-info fade in" style="display: none" id="wid-id-413">
...
<div class="jarviswidget" id="wid-id-411"  data-widget-deletebutton="false" data-widget-editbutton="false">
    <header>
