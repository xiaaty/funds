...
<div class="bdr1 mt10 mb10">
    ...
    <div class="jarviswidget m15" id="wid-id-5113" data-widget-sortable="false" data-widget-editbutton="false" data-widget-deletebutton="false">
        ...
        <!-- widget div-->
        <div class="">
            <form class="smart-form" action="${contextPath}/bill/queryLendReturnList"  id="accountForm">
                <!-- widget edit box -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="input" style="width:210px">
                                        ...
                                        <input type="hidden" name="map[businessType]" value="4">
                                    </label>
                                </td>
                            </tr>
        ...
        $("#accountQueryButton").click(function(){
        	...
        	if(queryamount!= "") {
				if(!numrg.test(queryamount)){
					var msg = "赎回金额输入有误 请输入有效的数字 ，可以有两位小数!  ";
					alert(msg);
					$("#queryamount").focus();
					return false;
				}
