...
<div class="bdr1 mt10 mb10">
    ...
    <div class="jarviswidget m15" id="wid-id-5113" data-widget-sortable="false" data-widget-editbutton="false" data-widget-deletebutton="false">
        ...
        <!-- widget div-->
        <div class="">
            <form class="smart-form" action="${contextPath}/bill/queryLendPaymentList"  id="accountForm">
                <!-- widget edit box -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="input" style="width:210px">
                                        ...
                                        <input type="hidden" name="map[businessType]" value="3">
                                    </label>
                                </td>
                            </tr>
    ...
    $(document).ready(function () {
        ...
        $("#accountQueryButton").click(function(){
        	...
        	if(queryamount!= "") {
				if(!numrg.test(queryamount)){
					var msg = "出借金额输入有误 请输入有效的数字 ，可以有两位小数!  ";
					alert(msg);
					$("#queryamount").focus();
					return false;
				}
       ...
       var common_table_bank = DT_ajax_page("borrow-rep-table1",true,$('#bankRecordForm'),columns,false,5,[{
        ...
        $("#bankQueryForm").click(function(){
        	...
        	if(incomeStart!= "") {
				if(!numrg.test(incomeStart)){
					var msg = "收入金额[from]输入有误 请输入有效的数字 ，可以有两位小数!  ";
					alert(msg);
					$("#incomeStart").focus();
					return false;
				}
        	...
        	if(incomeEnd!= "") {
				if(!numrg.test(incomeEnd)){
					var msg = "收入金额[to]输入有误 请输入有效的数字，可以有两位小数!  ";
					alert(msg);
					$("#incomeEnd").focus();
					return false;
				}
