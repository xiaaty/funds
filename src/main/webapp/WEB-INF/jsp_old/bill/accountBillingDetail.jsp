            ...
            <section id="widget-grid">
                <div class="row">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget" id="accountBillingDetail-id-5220" data-widget-sortable="false" data-widget-editbutton="false" data-widget-deletebutton="false" style="display: none">
                            <header>
                                <h2>快速搜索</h2>
                            </header>

                            <div>
                                <form class="smart-form" action="${contextPath}/bill/accountBillingDetail" method="post" id="searchForm">
                                    <!-- widget content -->
                        ...
                        <div class="jarviswidget" id="accountBillingDetail-id-5221" data-widget-sortable="false" data-widget-editbutton="false" data-widget-deletebutton="false" >
                            <header>
                                <h2 class="b">入账</h2>
                            </header>
                                        ...
                                        <table id="borrow-rep-table1" class="table table-bordered table-striped tc" style="min-width:800px">
                                            ...
                                            <c:forEach var="record" items="${page.list}">
                                                <tr>
                                                    ...
                                                    <td>${record["AMOUNT"]}</td>
                                                    <td>${record["AMOUNTDETAIL"]}</td>
                                                    <td>${accountMap[record["TYPE"]]}</td>
