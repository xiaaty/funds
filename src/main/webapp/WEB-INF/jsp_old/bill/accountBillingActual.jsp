            ...
            <section id="widget-grid">
                <div class="row">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget" id="accountBillingActual-id-522" data-widget-sortable="false" data-widget-editbutton="false" data-widget-deletebutton="false" style="display: none">
                            <header>
                                <h2>快速搜索</h2>
                            </header>

                            <div>
                                <form class="smart-form" action="${contextPath}/bill/accountBillingActual" method="post" id="searchForm">
                                    <!-- widget content -->
                        ...
                        <div class="jarviswidget" id=accountBillingActual-id-524" data-widget-sortable="false" data-widget-editbutton="false" data-widget-deletebutton="false">
                            <header>
                                <h2 class="b">入账</h2>
                            </header>
                                        ...
                                        <table id="borrow-rep-table1" class="table table-bordered table-striped tc" style="min-width:1400px">
                                            ...
                                            <c:forEach var="record" items="${page.list}">
                                                <tr>
                                                    ...
                                                    <td>${record["NAME"]}</td>
                                                    <td>${record["AMOUNT"]}</td>
                                                    <td>${record["REPAYMENT_DATE_PLAN"]}</td>
                                                    <td>${record["REPAYMENT_TIMES"]}</td>
                                                    <td>${record["PRINCIPAL"]}</td>
                                                    <td>${record["ACCRUAL"]}</td>
                                                    <td>${record["SERVICE_FEE"]}</td>
                                                    <td>${record["SUBTOTAL"]}</td>
                                                    <td>${record["REPAYMENT_DATE"]}</td>
                                                    <td>${record["CAPITAL"]}</td>
                                                    <td>${record["INTEREST"]}</td>
                                                    <td>${record["OTHER_FEE"]}</td>
                                                    <td>${record["TOTAL"]}</td>
