...
<html lang="en">
<head>
    <title>内审系统--账户管理--银行账户管理--银行账户详情</title>
...
<div class="jarviswidget" id="wid-id-3210" data-widget-deletebutton="false" data-widget-editbutton="false">
    <header>
        <h2>我的账户</h2>
    </header>
    <!-- widget div-->
                ...
                <div class="mt10 mb10">
                    <table class="table lh32 tc">
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="tl">
                                    <li>开户人姓名：${bankBean.name}</li>
                                    <li>卡号：${bankBean.cardNo}</li>
                                    <li>开户支行：${bankBean.openBankBranch}</li>
                                    <li>账户状态：${accountMap[bankBean.status]}</li>
                                </ul>
                            </td>
                            <td>
                                <div style="margin:0 auto;display: none">
                                    <table class="tc" style="width:680px">
                                        ...
                                        <tr class="b f20 pb10" style="color:#c7254e;border-bottom:1px #c7254e solid">
                                            <td>￥16544.22</td>
                                            <td>0.00</td>
                                            <td>0.00</td>
                                        </tr>
...
<div class="jarviswidget" id="wid-id-3211" data-widget-deletebutton="false" data-widget-editbutton="false">
    <header>
        <h2>快速搜索</h2>
    </header>
    <!-- widget div-->
    <div>
        <form id="bankListDetail" class="smart-form" action="${contextPath}/account/bankListDetail" method="post" >
            <!-- widget edit box -->
            <div class="jarviswidget-editbox">
                <!-- This area used as dropdown edit box -->
            </div>
...
<td colspan="2"></td>
                ...
                <footer>
                    <input type="hidden" name="id" value="${bankBean.id}">
...
<div class="jarviswidget" id="wid-id-3212"  data-widget-deletebutton="false" data-widget-editbutton="false">
    <header>
                    ...
                    <c:forEach var="record" items="${page.list}">
                        <tr class="table_input">
                           <%-- <td><input type="checkbox" name="id" value="${record.id}"/></td>--%>
                            ...
                            <td><fmt:formatDate value="${record.trans}" pattern="yyyy-MM-dd"/></td>
                            <td><fmt:formatDate value="${record.trans}" pattern="HH:mm:ss"/></td>
                            ...
                            <td>${record.accountOrg}</td>
                            <td>${record.transSite}</td>
...
<div id="upload" title="<div class='widget-header'><h4 class='b'>导入</h4></div>">
    <form id="uploadForm" method="post" action="${contextPath}/account/uploadAccount" enctype="multipart/form-data">
        ...
        <input type="hidden" name="accountID" value="${bankBean.id}">
...
<script>
    $(document).ready(function() {
        ...
        DT_page("borrow-rep-table",true,'${page.JSON}',$("#bankListDetail"));
        ...
        $("#returnParent").click(function(){
            window.open("${contextPath}/account/bankAccountList","_self");
        });
