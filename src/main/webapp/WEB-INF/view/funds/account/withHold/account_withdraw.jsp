		...
		<script type="text/javascript">
                $(function(){
                    $("#rechargeAcct").click(function(){
                        ...
                        gqi.post("${cxt}/web/updateCustomerWithdraw",{"custId":custId,"businessType":businessType,"amount":ammount},null,function(data){
                        ...
                        <tr>
                            ...
                            <td><input class="input03" value="" style="width:190px;" name="amount" id="amount"></td>
                                    ...
                                    <tr>
                                        ...
                                        <button id="btn-success" onclick="location.href='${contextPath}/funds/accountBusinessList/${withDrawId}'" class="btn btn-primary"  id="rechargeAcct" type="button">取消</button>
                                    	</td>
                                    	</tr>
                                    </footer>
                                </div>
