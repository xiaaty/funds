                                            ...
                                            <table class="table lh32">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label class="input">
                                                                <input type="text" style="width:210px" name="mobile" value="${FssCustomerEntity.mobile}" />
                                                            </label>
                                                        </td>
                                                         <td class="tr">证件号码：</td>
                                                        <td>
                                                            <label class="input" style="width:210px" >
                                                                <input type="text" name="cert_no" value="${FssCustomerEntity.cert_no}" />
                                                            </label>
                                                        </td>
                                                        <td class="tr">姓名:</td>
                                                        <td>
                                                            <label class="input"  style="width:210px" >
                                                                <input type="text" name="name" value="${FssCustomerEntity.name}"/>
                                                            </label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tbody>
                                             <c:forEach items="${page.list}" var="t">
                                                <tr class="success">
                                                    ...
                                                    <td><a href="${contextPath}/fss/account/customerAccountDetail/${t.cust_no}">查看账户资产</a></td> 
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
