...
<head>
    <meta charset="UTF-8">
    <title>资金清结算系统--标的财务汇总审核回盘文件--冠群驰骋投资管理(北京)有限公司</title>
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
 				<!-- NEW WIDGET START -->
                      <div class="jarviswidget" id="wid-id-299"  data-widget-deletebutton="false" data-widget-editbutton="false">
                            ...
                            <div>
                                <form class="smart-form" action="${contextPath}/fstp/bidFinanceSumAudit"  method="post" id="auditForm">
...
<script src="${contextPath}/js/jquery.alerts.js" ></script>
 <script type="text/javascript" charset="utf-8">
	 $(document).ready(function () {
	     pageSetUp();
	     DT_page("borrow-rep-table12", true, '${page.JSON}', $("#auditForm"));
	 });
