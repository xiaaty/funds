...
public class CreateTXT  {
	...
	public void createFinanceSumTXT() throws FssException{
		...
		for (FssFinanceSumEntity info : queryFinaSum) {
			 ...
			 write.append(info.gettReCaptical()+"|");
			 write.append(info.gettReInterest()+"|");
			 write.append(info.getlReTime()+"|");
			 write.append(info.getaSquareTime()+"|");
			 write.append(info.getaReCaptical()+"|");
			 write.append(info.getaReInterest()+"|");
			 write.append(info.getTodayReCaptical()+"|");
			 write.append(info.getTodayReInterest()+"|");
			 write.append(info.geteReCaptical()+"|");
			 write.append(info.geteReInterest()+"|");
	...
	public void createCreditInfoCVS() throws FssException{
		...
		for (FssBusinessTradeEntity info : queryBusinessTrade) {
			...
			write.append(info.getAmt()+"|");
			write.append(info.getCharge()+"|");
			write.append(info.getThisRepaymentPrincipal()+"|");
			write.append(info.getThisRepaymentInterest()+"|");
