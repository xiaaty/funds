package com.gqhmt.fss.pay.fuiou.connection;
...
public class ConnectionFuiou {
    ...
    public static Map send(String url,Map map){
...
//        }
     ...
     * @throws Exception
     */
    private static InputStream sendHttpRequest(String url, String param) throws Exception{
