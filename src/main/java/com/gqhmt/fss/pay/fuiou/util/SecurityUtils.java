package com.gqhmt.fss.pay.fuiou.util;
...
public class SecurityUtils {
	 ...
	 */
	private static String privateKeyPath="com/fuiou/prkey.key";
	
	/**
	 * 公钥文件路径 如：D:/rsa/pbkey.key
	 */
	private static String publicKeyPath="com/fuiou/pbkey.key";
	...
	public static void initPrivateKey(){
		try {
				if(privateKey==null){
					privateKey = getPrivateKey(getClassPath()+privateKeyPath);
				}
		} catch (Exception e) {
	...
	public static void initPublicKey(){
		try {
			if(publicKey==null){
				publicKey = getPublicKey(getClassPath()+publicKeyPath);
			}
		} catch (Exception e) {
			System.out.println("SecurityUtils初始化失败" + e.getMessage());
			e.printStackTrace();
    ...
    public static String getClassPath(){
        String path = SecurityUtils.class.getResource("").getPath();
        String className  = SecurityUtils.class.getName();
        String simName = SecurityUtils.class.getSimpleName();
