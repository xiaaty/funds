/**
 *<company>冠群驰骋</company>
 *<project>线上P2P系统</project>
 */
 ...
 * @author yangfei
 * @version 1.0
 * @createTime:2014-4-27下午3:06:59
 */
@SuppressWarnings({ "rawtypes", "unchecked" })
public class JsonTransferUtil {
	
	static final String RAWTYPES_UNCHECKED = "{rawtypes,unchecked}";
	...
	* @return void    
	 * @throws java.io.IOException
	*/ 
	public static void printObject(HttpServletResponse httpServletResponse,Object obj) throws IOException {
		JSONObject jsObject =JSONObject.fromObject(obj);
		printStr(httpServletResponse,jsObject.toString());
	}
	...
	* @return void    
	*/ 
	public static void printArray(HttpServletResponse httpServletResponse,List<?> list) throws IOException{
		JSONArray jsArray=JSONArray.fromObject(list);
		printStr(httpServletResponse,jsArray.toString());
	}
	...
	* @return void    
	*/ 
	public static void printStr(HttpServletResponse httpServletResponse,JSONObject json) throws IOException{
		httpServletResponse.setCharacterEncoding("UTF-8");
		httpServletResponse.setContentType("text/x-json;charset=UTF-8");
		PrintWriter pw = httpServletResponse.getWriter();
		pw.print(json);
	...
	* @Title: printStr 
	* @author 王晓鹏
	* @Description: 打印jsonArray
	* @date 2014年6月7日 下午5:39:01 
	* @param httpServletResponse
	* @param json
	* @throws java.io.IOException
	*/ 
	public static void printStr(HttpServletResponse httpServletResponse,JSONArray json) throws IOException{
		httpServletResponse.setCharacterEncoding("UTF-8");
		httpServletResponse.setContentType("text/x-json;charset=UTF-8");
		PrintWriter pw = httpServletResponse.getWriter();
		pw.print(json);
