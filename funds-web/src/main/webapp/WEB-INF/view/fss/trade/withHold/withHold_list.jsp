                                    ...
                                    <div class="mt10 mb10">
                                        <table class="table lh32">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="input">
                                                        <fss:dictView key="${process.status}" />
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="input" style="width:210px">
                                                        <fss:dictView key="${process.processState}" />
                                                    </label>
                                                </td>
                                                <td class="tr">合同号 : </td>
                                                <td>
                                                    <label class="input" style="width:210px">
                                                       ${process.loanContractNo}
                                                    </label>
                                                </td>
                                                <td class="tr">创建时间 : </td>
                                                <td>
                                                    <label class="input">
                                                        <fss:fmtDate value="${process.createTime}"/>
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="input" style="width:210px">
                                                        ${process.realTradeAmount}
                                                    </label>
                                                </td>
                                                <td class="tr">修改时间 : </td>
                                                <td>
                                                    <label class="input">
                                                        <fss:fmtDate value="${process.modifyTime}"/>
                                                    </label>
                                                </td>
                                            </tr>
                                            </tbody>
