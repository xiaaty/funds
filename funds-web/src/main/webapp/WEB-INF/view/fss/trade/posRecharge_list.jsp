...
<head>
    <meta charset="UTF-8">
    <title>交易记录--pos充值--资金清结算系统--冠群驰骋投资管理(北京)有限公司</title>
            ...
            <div class="row">
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jarviswidget" id="moList"  data-widget-deletebutton="false" data-widget-editbutton="false">
                        ...
                        <div>
                            <form class="smart-form" id="posForm" action="${contextPath}/trade/tradeApply/posRechargeRecord"  method="post" >
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id = "resultState" name = "resultState" style="width:200px;height: 30px;">
                                                        ...
                                                        <option  <c:if test="${map.resultState==13010001}"> selected="selected" </c:if> value="13010001">POS订单创建成功</option>
                                                        <option  <c:if test="${map.resultState==13010002}"> selected="selected" </c:if> value="13010002">POS订单创建失败</option>
                    ...
                    <!-- NEW WIDGET START -->
                    <div class="jarviswidget jarviswidget-color-darken" id="dictList-id-0325"  data-widget-deletebutton="false" data-widget-editbutton="false">
                        <header>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function() {
        pageSetUp();
        DT_page("borrow-rep-table12", true, '${page.JSON}', $("#posForm"));
    });
