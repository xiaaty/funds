...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.icons = {
			leftArrow: this.fontAwesome ? 'fa-arrow-left' : (this.bootcssVer === 3 ? 'glyphicon-arrow-left' : 'fa fa-arrow-left'),
			rightArrow: this.fontAwesome ? 'fa-arrow-right' : (this.bootcssVer === 3 ? 'glyphicon-arrow-right' : 'fa fa-arrow-right')
		};
	...
	var DPGlobal = {
		...
		footTemplate:     '<tfoot><tr><th colspan="7" class="resetClear">清空</th></tr></tfoot>'
	};
