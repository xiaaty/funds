 ...
 */
@Entity
@Table(name = "t_gq_fss_restrictions_bank")
public class ChannelRestrictionsEntity {
    ...
    @Column(name = "option_bank")
    private String optionBank;          //配置银行

    @Column(name = "option_type")
    private String optionType;          //配置类型
    ...
    public ChannelRestrictionsEntity() {
    }
}
