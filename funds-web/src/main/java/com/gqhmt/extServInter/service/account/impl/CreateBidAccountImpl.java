...
public class CreateBidAccountImpl implements ICreateBidAccount {
    ...
    public Response execute(SuperDto dto) {
    	...
    	try {
			...
			createAccountEvent.createBidAcocunt(cDto.getTrade_type(),cDto.getCust_no(),cDto.getCust_name(),cDto.getCert_no(),cDto.getMobile_phone(),cDto.getBid_id(),cDto.getBusi_no(),cDto.getSeq_no());
