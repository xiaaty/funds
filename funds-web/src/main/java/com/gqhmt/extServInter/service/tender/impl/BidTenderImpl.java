...
public class BidTenderImpl implements IBidTender {
    ...
    public Response execute(SuperDto dto) {
    	...
    	try {
			...
			fundsTenderImpl.bid(bidDto.getTrade_type(), bidDto.getBid_id(),bidDto.getTender_no(),bidDto.getProduct_title(),bidDto.getCust_no(),bidDto.getInvest_type(),bidDto.getReal_Amount(),bidDto.getLoan_cust_id(),bidDto.getMoto_cust_id(),bidDto.getBonus_Amount(),bidDto.getBusi_bid_no(),bidDto.getBusi_no());
