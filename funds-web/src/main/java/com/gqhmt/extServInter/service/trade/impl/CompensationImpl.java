...
public class CompensationImpl implements ICompensation {
	 ...
	 * @return
     */
	@APITradeTypeValid(value = "11070001,11070002,11070003,11070004,11130001,11130002,11130003,11130004,11130005,11060001,11060002,11060003,11060004,11060005,11060006,11060007,11060008")
    @Override
