...
public class BonusImpl implements IBonus {
	...
	public Response execute(SuperDto dto) {
    	...
    	try {
			...
			fssBonusService.createBonus(bDto.getMchn(),bean.getSeq_no(),bDto.getTrade_type(),bean.getCust_id(),bean.getBusi_no(),bean.getAmount(),entity.getId(),bean.getBusi_type());
			}
