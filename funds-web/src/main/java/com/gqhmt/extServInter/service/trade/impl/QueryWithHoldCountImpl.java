...
import com.gqhmt.extServInter.service.trade.IQueryWithHoldCount;
 ...
 */
@Service
public class QueryWithHoldCountImpl implements IQueryWithHoldCount {
	@Resource
	 ...
	 * @return
     */
	@APITradeTypeValid(value = "11021107")
    @Override
    public Response execute(SuperDto dto) {
    	...
    	try {
			...
			int count =fundSequenceService.queryWithHoldCount(fundAccountEntity.getId());
